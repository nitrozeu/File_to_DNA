...
public class node implements Serializable {
    ...
    */
    ...
    node(){}
    node(char k,int f , boolean l){
        key=k;   freq=f;  isLeaf=l;
        combChar="";
    }
